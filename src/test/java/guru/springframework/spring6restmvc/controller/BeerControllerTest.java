...
class BeerControllerTest {
    ...
    void testListBeers() throws Exception {
        // showInventory should be null and not false!
        given(beerService.listBeers(any(), any(), any(), any(), any())).willReturn(beerServiceImpl.listBeers(null, null, null, null, null));
